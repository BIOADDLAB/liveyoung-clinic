    ...
    faqs: [
        {
            ...
            answer: "울쎄라피는 초음파를 이용해 처진 근막층(SMAS)을 끌어올리는 '끌고 리프팅'에 효과적이며,"
        },
        {
        ...
        },
        {
            ...
            answer: "시술직후 일시적인 타이트닝감을 느낄 수 있으나, 본격적인 효과는 보통 1~3개월에 걸쳐 서서히 나타나며, 3~6개월 사이 가장 뚜렷하게 체감됩니다."
        },
        {
            question: "리니어지 효과시기",
...
export const TIGHTENING_DATA: TreatmentPageData = {
    ...
    faqs: [
        ...
        },
        {
            ...
            answer: "보톡스 효과는 시술 부위와 개인의 근육 상태에 따라 차이가 있습니다."
        },
        {
    ...
    faqs: [
        {
            ...
            answer: "스킨부스터는 제품 종류와 시술 부위, 피부상태에 따라 손주사,인젝터,캐뉼라 등 다양한 방식으로"
        },
        {
        ...
        {
            question: "시술 후 엠보싱(울퉁불퉁한 자국) 현상은 얼마나 가나요?",
        ...
        {
            question: "리쥬란, 쥬베룩, 리바이브,레티젠,리투오, 리쥬에이드 등 스킨부스터 종류는 어떻게 선택하나요?",
        ...
        },
        {
            ...
            answer: "스킨부스터 자체만으로도 효과가 있지만 재생 주사나\n시술 만으로도 효과를 보실수 있지만 함께 이를 병행해주셨을때 최고의 효과를 끌어내실수있습니다."
        }
    ],
    ...
    faqs: [
        {
            ...
            answer: "포텐자는 미세 니들을 사용한 시술이기 때문에 통증은 있는 시술입니다. 시술 전 마취크림을 도포해드리고 있으나 통증에 취약하신 분은 마취시간을 늘려드리고 있습니다. 시술 후 주사자국이나 붉음증이 남을 수 있으며 개인의 피부 재생능력에 따라 가라앉는데까지 길게는 1~2주까지 지속됩니다."
        },
        {
