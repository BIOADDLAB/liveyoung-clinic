...
const PRECAUTION_GUIDES = {
    pigmentationLaser: {
        title: "색소레이저",
        items: [
            "레이저 직후에는 약간의 붉음이나 따끔거림이 있을 수 있으며 대부분 일시적으로 호전됩니다.",
            "레이저 후 일시적으로 피부가 건조하고 당기는 느낌이 있을 수 있어서 보습제나 재생크림은 충분히 발라주는 것이 좋습니다.",
            "외출할 때는 선크림을 꼭 발라주시고, 시술 후 피부가 예민한 상태이기 때문에 강한 햇빛은 가능한 한 오래 쬐지 않도록 주의해주시는 것이 좋습니다.",
            "일주일 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다."
        ]
    },
    liftingLaser: {
        title: "울쎄라 / 리니어지",
    ...
    lephton: {
        title: "레프톤",
        items: [
            "특별한 주의사항은 없으나 일주일 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다.",
    ...
    co2Laser: {
        ...
        items: [
            ...
            "시술 후 1~2주 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다.",
    ...
    potenza: {
        title: "포텐자",
        items: [
            "시술 후 당일은 화끈거리는 느낌, 붉음증, 부기가 발생하실 수 있으나 개인마다 증상에 차이가 있어 3일 내로 사라지게 됩니다.",
            "세안과 화장은 가급적 다음날부터 하시고, 세안 시에는 미온수로 부드럽게 하고 문지르지 않도록 주의해주시는 것이 좋습니다.",
            "얼굴 각질이 일어나는 경우 억지로 세게 밀어 제거하는 것은 좋지 않고, 보습제와 재생에 도움이 될 수 있는 제품을 충분히 발라주시는 게 좋습니다.",
            "일주일 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다.",
            "시술 후에는 피부가 평소보다 예민해진 상태일 수 있어서 외출 시에 자외선 차단제를 발라주시는 것이 좋습니다."
        ]
    },
    juvelook: {
        title: "쥬베룩",
        items: [
            "시술 직후에는 부기, 멍, 약간의 통증, 주사 부위의 작은 뭉침이나 단단한 느낌이 있을 수 있습니다. 이는 약물이 자리 잡는 과정에서 나타날 수 있는 자연스러운 반응으로 대부분 시간이 지나면서 서서히 완화됩니다.",
            "시술한 부위를 강하게 문지르는 행동은 피해주시고, 마사지나 경락처럼 압력이 크게 가해지는 관리는 일주일 정도 피해주시는 게 좋습니다.",
            "일주일 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다.",
            "세안과 가벼운 화장은 보통 다음날부터 가능하며, 보습제와 재생크림은 충분히 발라주시는 게 좋습니다."
        ]
    },
    skinBooster: {
        title: "스킨부스터",
        items: [
            "시술 직후에는 붉은기, 부기, 멍, 주사바늘 자국이 동반될 수 있으며, 피부 표면이 엠보싱처럼 살짝 볼록하게 올라와 보일 수 있습니다. 이는 약물이 주입되면서 나타나는 자연스러운 반응으로, 대부분 수시간에서 2~3일 이내에 점차 가라앉습니다.",
            "시술 후 일시적으로 피부가 예민하거나 건조한 느낌이 들 수 있어 스크럽, 필링 등 자극적인 제품 사용은 당분간 피해주시는 걸 권장드립니다.",
            "세안과 가벼운 화장은 보통 다음날부터 가능하며, 보습제와 재생크림은 충분히 발라주시는 게 좋습니다.",
            "일주일 정도는 사우나나 찜질방 등 너무 더운 환경과 과격한 운동, 음주, 흡연은 피하시는 것이 좋습니다."
        ]
    },
    ...
    skinBotox: {
        title: "스킨보톡스",
        items: [
            "시술 후에는 엠보싱 현상이나 약간의 붓기, 멍, 주사바늘 자국이 일시적으로 나타날 수 있으며 대부분 수시간에서 수일 내 자연스럽게 호전됩니다.",
